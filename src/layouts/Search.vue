      ...
      <q-input @click="searchPopout = true"  dark dense standout debounce="500" v-model="text" input-class="text-right" class="q-ml-md search-box">
        ...
        <div  class="search-extension" :class="{ extensionActive:searchPopout, extensionDeactive:searchPopout==false }">
          ...
          <q-tabs
            ...
            <q-btn-dropdown auto-close stretch flat label="Now" class="colorGreen">
                <q-list>
            ...
            <!-- close button -->
            <q-btn flat @click="searchPopout = false" class="close-btn" label="X" color="negative"></q-btn>
          ...
          <q-tab-panels v-model="tab" animated>
            <q-tab-panel name="enterprise" class="ent-panel">
              ...
              <q-card v-for="n in 2" flat class="enterprise-card_container">
                ...
                <div class="info-name_container col-2"><p class="info-name_txt">Nep Enterprise <br><span class="usr-name_txt">Saugat Thapa</span></p></div>
                <div class="info-distance_container info-container col">
                  <img class="info-icons distance-icon" src="../statics/icons/distance-icon.svg" alt="distance icon"> 
                  <div class="distance-txt_info txt-info"><p class="info-header">Distance<br><span class="info-value">5km</span></p></div>
                </div>
                <div class="info-invoice_container info-container col">
                  <img class="info-icons invoice-icon" src="../statics/img/Invoice-graphics.png" alt="invoice icon"> 
                  <div class="invoice-txt_info txt-info"><p class="info-header">Invoice<br><span class="info-value">2412341</span></p></div>
                </div>
                <div class="info-contact_container info-container col">
                  <img class="info-icons contact-icon" src="../statics/icons/contact-icon.svg" alt="contact icon"> 
                  <div class="contact-txt_info txt-info"><p class="info-header">Phone no.<br><span class="info-value">+977 987231764</span></p></div>
                </div>
                 <div class="info-email_container info-container col">
                  <img class="info-icons email-icon" src="../statics/icons/email-icon.svg" alt="email icon"> 
                  <div class="email-txt_info txt-info"><p class="info-header">Email address<br><span class="info-value">Saugat@example.com</span></p></div>
                </div>
                 <div class="info-customer_container col">
                      <img class="customer-icon" src="../statics/icons/customers-icons.svg" alt="customer icon"> 
                      <div class="customer-txt_info "><p class="info-header">Customers<br><span class="info-value">234</span></p></div>
                </div>
            ...
            <q-tab-panel name="quotation">
              <p class="text-black">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero nam mollitia architecto ab doloremque omnis! Atque beatae consequuntur quo architecto.</p>
            </q-tab-panel>
